...
java -jar %JAR_PATH% generate -i %OPENAPI_FILE% -g aspnetcore -o build/openapi --global-property models ^
  --additional-properties=targetFramework=net8.0,aspnetCoreVersion=8.0,packageName=Todo.Api > build\generate.log 2>&1
