...
namespace AboutCleanCode
{
    ...
    public static class Contract
    {
        ...
        public static void RequiresNotNull<T>(T argument, [CallerArgumentExpression("argument")] string argumentName = null) where T : class
        {
            if (argument == null)
            {
        ...
        public static void RequiresNotNullNotEmpty(string argument, [CallerArgumentExpression("argument")] string argumentName = null)
        {
        ...
        public static void RequiresNotNullNotEmpty<T>(IEnumerable<T> argument, [CallerMemberName] string argumentName = null)
        {
            if (argument == null)
            {
                throw new ArgumentNullException(argumentName);
